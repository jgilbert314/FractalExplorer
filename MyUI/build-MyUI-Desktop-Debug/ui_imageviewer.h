...
public:
    ...
    void setupUi(QMainWindow *ImageViewer)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 68, 595));
        ...
        sizePolicy2.setHeightForWidth(diagBoxP->sizePolicy().hasHeightForWidth());
        diagBoxP->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(calcLabelP_u->sizePolicy().hasHeightForWidth());
        calcLabelP_u->setSizePolicy(sizePolicy3);
...
""));
        ...
        sizePolicy4.setHeightForWidth(label_M_RsV->sizePolicy().hasHeightForWidth());
        label_M_RsV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(label_M_NIV->sizePolicy().hasHeightForWidth());
        label_M_NIV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy4.setHeightForWidth(label_M_IoV->sizePolicy().hasHeightForWidth());
        label_M_IoV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(label_M_NRV->sizePolicy().hasHeightForWidth());
        label_M_NRV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(label_M_NKV->sizePolicy().hasHeightForWidth());
        label_M_NKV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy4.setHeightForWidth(label_M_IsV->sizePolicy().hasHeightForWidth());
        label_M_IsV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(label_M_RoV->sizePolicy().hasHeightForWidth());
        label_M_RoV->setSizePolicy(sizePolicy4);
        ...
        labelM->setGeometry(QRect(0, 0, 465, 282));
        ...
        sizePolicy2.setHeightForWidth(imageLabelM->sizePolicy().hasHeightForWidth());
        imageLabelM->setSizePolicy(sizePolicy2);
        ...
        sizePolicy4.setHeightForWidth(label_P_RoV->sizePolicy().hasHeightForWidth());
        label_P_RoV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(label_P_NKV->sizePolicy().hasHeightForWidth());
        label_P_NKV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy4.setHeightForWidth(label_P_IsV->sizePolicy().hasHeightForWidth());
        label_P_IsV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(label_P_NIV->sizePolicy().hasHeightForWidth());
        label_P_NIV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(label_P_NRV->sizePolicy().hasHeightForWidth());
        label_P_NRV->setSizePolicy(sizePolicy5);
        ...
        sizePolicy4.setHeightForWidth(label_P_CrV->sizePolicy().hasHeightForWidth());
        label_P_CrV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(label_P_IoV->sizePolicy().hasHeightForWidth());
        label_P_IoV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(label_P_CiV->sizePolicy().hasHeightForWidth());
        label_P_CiV->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(label_P_RsV->sizePolicy().hasHeightForWidth());
        label_P_RsV->setSizePolicy(sizePolicy4);
        ...
        labelP->setGeometry(QRect(0, 0, 465, 282));
        ...
        sizePolicy6.setHeightForWidth(diagBoxM->sizePolicy().hasHeightForWidth());
        diagBoxM->setSizePolicy(sizePolicy6);
